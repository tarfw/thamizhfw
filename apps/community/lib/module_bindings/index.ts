...
import GroupChatRow from "./group_chat_table";
import GroupMemberRow from "./group_member_table";
import MessageRow from "./message_table";
import PrivateChatRow from "./private_chat_table";
...
const tablesSchema = __schema({
  groupChat: __table({
    name: 'group_chat',
    indexes: [
      { accessor: 'id', name: 'group_chat_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'group_chat_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, GroupChatRow),
  groupMember: __table({
    name: 'group_member',
  ...
  privateChat: __table({
    name: 'private_chat',
    indexes: [
      { accessor: 'roomId', name: 'private_chat_room_id_idx_btree', algorithm: 'btree', columns: [
        'roomId',
      ] },
    ],
    constraints: [
      { name: 'private_chat_room_id_key', constraint: 'unique', columns: ['roomId'] },
    ],
  }, PrivateChatRow),
  reaction: __table({
    name: 'reaction',
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("create_private_chat", CreatePrivateChatReducer),
  ...
  __reducerSchema("set_avatar_url", SetAvatarUrlReducer),

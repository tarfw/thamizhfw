...
const url =
  process.env.TURSO_DATABASE_URL || process.env.EXPO_PUBLIC_TURSO_DATABASE_URL;
const authToken =
  process.env.TURSO_AUTH_TOKEN || process.env.EXPO_PUBLIC_TURSO_AUTH_TOKEN;
...
async function main() {
  ...
  const entities = await storage.bulkCreateEntities([
    {
      type: "person",
      name: "M.K. Stalin",
      aliases: ["Stalin", "Chief Minister"],
      description: "Chief Minister of Tamil Nadu, DMK leader",
      metadata: { party: "DMK", role: "CM" },
    },
    {
      type: "person",
      name: "Udhayanidhi Stalin",
      aliases: ["Udhay"],
      description: "Minister for Youth Welfare and Sports Development",
      metadata: { party: "DMK" },
    },
    {
      type: "person",
      name: "Edappadi K. Palaniswami",
      aliases: ["EPS", "Palaniswami"],
      description: "Former Chief Minister, AIADMK leader",
      metadata: { party: "AIADMK" },
    },
    {
      type: "person",
    ...
    },
    {
      ...
      name: "K. Annamalai",
      aliases: ["Annamalai"],
      description: "Tamil Nadu BJP President",
      metadata: { party: "BJP" },
    },
    {
      type: "organization",
      name: "DMK",
      aliases: ["Dravida Munnetra Kazhagam"],
      description: "Dravidian political party in Tamil Nadu",
      metadata: { founded: 1949 },
    },
    {
      type: "organization",
      name: "AIADMK",
      aliases: ["All India Anna Dravida Munnetra Kazhagam"],
      description: "Dravidian political party in Tamil Nadu",
      metadata: { founded: 1972 },
    },
    {
      type: "organization",
      name: "BJP Tamil Nadu",
      aliases: ["Bharatiya Janata Party TN"],
      description: "Tamil Nadu state unit of BJP",
      metadata: {},
    },
    {
      type: "organization",
      name: "Greater Chennai Corporation",
      aliases: ["GCC", "Chennai Corporation"],
      description: "Municipal body governing Chennai",
      metadata: {},
    },
    {
      type: "location",
    ...
    },
    {
      ...
      name: "Coimbatore",
      aliases: [],
      description: "Major industrial city in Tamil Nadu",
      metadata: { type: "city" },
    },
    {
      type: "location",
    ...
    },
    {
      ...
      aliases: ["Women's Rights Scheme"],
      description:
        "Monthly financial assistance scheme for women heads of families in Tamil Nadu",
      metadata: { launched: "2023" },
    },
    {
      type: "event",
      ...
      aliases: [],
      description:
        "Education assistance scheme for girls in government schools",
      metadata: { launched: "2022" },
    },
    {
      type: "event",
      name: "Chennai Water Crisis 2026",
      aliases: [],
      description: "Acute water shortage affecting Chennai in May 2026",
  ...
  const articles = await storage.bulkCreateArticles([
    {
      ...
      excerpt:
        "Reservoirs at 20% capacity as city implements emergency water rationing across all zones.",
      status: "published",
    ...
    },
    {
      ...
      title:
        "Tamil Nadu Expands Kalaignar Women's Scheme to Cover 1.5 Crore Families",
      ...
      excerpt:
        "Government expands women's financial assistance scheme to reach 1.5 crore families statewide.",
      status: "published",
      category: "politics",
    ...
    },
    {
      ...
      title:
        "Investigation: Land Acquisition Irregularities in Coimbatore Industrial Corridor",
      ...
      excerpt:
        "Systematic under-compensation of farmers in Coimbatore-Salem industrial corridor exposed.",
      status: "published",
    ...
    },
    {
      ...
      excerpt:
        "EPS and OPS camps issue contradictory statements on alliance strategy.",
      status: "published",
      category: "politics",
    ...
    },
    {
      ...
      title:
        "Pudhumai Penn Scheme: How Education Assistance Changed Lives in Rural Tamil Nadu",
      ...
      excerpt:
        "Independent study shows 35% rise in girls' enrollment in government schools since scheme launch.",
      status: "published",
      category: "local",
    ...
    // ── Women Violence ────────────────────────────────────────────
    {
      ...
      title:
        "Domestic Violence Cases in Tamil Nadu Rise 22% in 2025, NCRB Data Shows",
      ...
      excerpt:
        "NCRB data reveals 38,742 domestic violence complaints filed in Tamil Nadu in 2025, a 22% increase over the previous year.",
      status: "published",
      ...
      authorId: "investigative-team",
      sourceUrl: null,
      metadata: { readingTime: 6, incidentStatus: "Reported" },
    },
    {
      slug: "salem-acid-attack-survivor-justice",
      title:
        "Salem: 19-Year-Old Survivor of Acid Attack Fights for Justice 18 Months On",
      ...
      excerpt:
        "An acid attack survivor from Salem continues to fight for justice 18 months after the assault, with compensation still unpaid.",
      status: "published",
      category: "women-violence",
      tags: [
        "acid-attack",
    ...
    },
    {
      ...
      title:
        "How Tamil Nadu's All-Women Police Stations Are Transforming Complaint Reporting",
      ...
      excerpt:
        "Study finds 65% rise in FIRs for gender-based crimes in districts with all-women police stations, but flags critical resource gaps.",
      status: "published",
      category: "women-violence",
    ...
    },
    {
      ...
      title:
        "Chennai NGO Helpline Receives 12,000 Calls in 2025 — Most from Marital Rape Survivors",
      ...
      excerpt:
        "56% of 12,047 helpline calls in 2025 were from marital rape survivors, highlighting the gap in India's rape laws.",
      status: "published",
      category: "women-violence",
      tags: [
        "marital-rape",
      ...
      authorId: "editor1",
      sourceUrl: null,
      metadata: { readingTime: 8, incidentStatus: "Reform Implemented" },
          },
          {
            slug: "tirunelveli-human-trafficking-bust"
      title:
        "Human Trafficking Ring Busted in Tirunelveli — 14 Women Rescued, 6 Arrested",
      ...
      excerpt:
        "14 women and girls rescued in coordinated anti-trafficking operation across Tirunelveli and Kanyakumari districts.",
      status: "published",
      category: "women-violence",
      tags: [
        "human-trafficking",
  ...
  for (const article of articles) {
    const title =
      article.title.toLowerCase() + " " + article.body.toLowerCase();
    for (const [name, id] of entityMap) {
      if (title.includes(name.toLowerCase())) {
        await storage.linkArticleEntity(
          article.id,
          id,
          0.8,
  ...
  await storage.bulkCreateConnections([
    ...
    {
      sourceId: getId("Udhayanidhi Stalin"),
      targetId: getId("DMK"),
      relationship: "member_of",
      strength: 1.0,
      evidence: [],
    ...
    {
      sourceId: getId("Udhayanidhi Stalin"),
      targetId: getId("M.K. Stalin"),
      relationship: "related_to",
      strength: 0.9,
      evidence: [],
    },
    {
      sourceId: getId("Edappadi K. Palaniswami"),
      targetId: getId("AIADMK"),
      relationship: "member_of",
      strength: 1.0,
      evidence: [],
    },
    {
      sourceId: getId("O. Panneerselvam"),
      targetId: getId("AIADMK"),
      relationship: "member_of",
      strength: 1.0,
      evidence: [],
    ...
    {
      sourceId: getId("K. Annamalai"),
      targetId: getId("BJP Tamil Nadu"),
      relationship: "works_for",
      strength: 1.0,
      evidence: [],
    },
    {
      sourceId: getId("BJP Tamil Nadu"),
      targetId: getId("AIADMK"),
      relationship: "related_to",
      strength: 0.6,
      evidence: [],
    ...
    {
      sourceId: getId("Greater Chennai Corporation"),
      targetId: getId("Chennai"),
      relationship: "located_in",
      strength: 1.0,
      evidence: [],
    },
    {
      sourceId: getId("Kalaignar Magalir Urimai Thittam"),
      targetId: getId("M.K. Stalin"),
    ...
    {
      sourceId: getId("Pudhumai Penn Scheme"),
      targetId: getId("Udhayanidhi Stalin"),
      relationship: "participated_in",
      strength: 0.9,
      evidence: [],
    },
    ...
    {
      sourceId: getId("Chennai Water Crisis 2026"),
      targetId: getId("Chennai"),
      relationship: "located_in",
      strength: 1.0,
      evidence: [],
    ...
    {
      sourceId: getId("Chennai Water Crisis 2026"),
      targetId: getId("Greater Chennai Corporation"),
      relationship: "related_to",
      strength: 0.8,
      evidence: [],
    },
